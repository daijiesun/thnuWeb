<template>
  <div class="thnu_NavMenv container-fuild">
    <nav class="navbar thnu_NavMenv navbar-default navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">校园服务
                <span class="caret"></span>
              </a>
              <ul class="dropdown-menu">
                <li>
                  <router-link :to="{path:'/expressage'}">代取快递</router-link>
                </li>
                <li>
                  <router-link :to="{path:'/partjob'}">兼职服务</router-link>
                </li>
                <li>
                  <router-link :to="{path:'/sport'}">校园活动</router-link>
                </li>
                <li>
                  <router-link :to="{path:'/goods'}">闲置物品</router-link>
                </li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">校园生活
                <span class="caret"></span>
              </a>
              <ul class="dropdown-menu">
                <li>
                  <router-link :to="{name:'/lose'}">寻物启事</router-link>
                </li>
                <li>
                  <router-link :to="{path:'/news'}">校园趣事</router-link>
                </li>
                <li>
                  <router-link :to="{path:'/love'}">校园告白</router-link>
                </li>
                <li>
                  <a href="http://tieba.baidu.com/f?ie=utf-8&kw=%E9%80%9A%E5%8C%96%E5%B8%88%E8%8C%83%E5%AD%A6%E9%99%A2&fr=search&red_tag=i2796961685">通师贴吧</a>
                </li>
              </ul>
            </li>
            <!-- 登录 -->
            <li v-if="!user">
              <a class="login" data-toggle="modal" data-target="#loginModal">登录</a>
            </li>
          ...
          <div class="modal-body">
            <form id="loginForm">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="recipient-name" name="email" placeholder="邮箱" v-model="formData.email">
              </div>
              <div class="form-group">
                <label for="message-text" class="control-label">密码:</label>
                <input type="password" class="form-control" id="message-text" name="password" placeholder="填写密码" v-model="formData.password">
              </div>
            </form>
          </div>
